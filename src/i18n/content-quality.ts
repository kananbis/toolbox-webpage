...
const toolDeepDives: Record<Lang, Partial<Record<ToolSlug, ToolDeepDive>>> = {
  ko: {
    ...
    "salary-net-calculator": {
      title: "2026년 월 공제 계산 기준",
      intro: "보험료와 세금은 하나의 공제율로 합산하지 않고, 제도별 산정 기준을 적용해 각각 계산합니다.",
      headers: ["항목", "계산 기준"],
      rows: [["국민연금", "근로자 부담률 4.75%, 기준소득월액 41만원~659만원 적용"], ["건강보험", "직장가입자 보험료율 7.19%의 근로자 부담분 3.595%"], ["장기요양보험", "건강보험료에 장기요양보험 비율을 적용"], ["고용보험", "근로자 부담률 0.9%"], ["근로소득세", "월 비과세를 제외한 급여와 부양가족·자녀 수에 따른 간이세액표"], ["지방소득세", "근로소득세의 10%"]],
      note: "산재보험은 일반적으로 사업주 부담이라 공제하지 않습니다. 비과세 항목, 상여금, 연말정산, 회사의 원 단위 처리에 따라 급여명세서와 차이가 날 수 있습니다. 기준 자료는 국민연금공단, 국민건강보험공단, 고용노동부, 국세청 및 국가법령정보센터를 확인했습니다.",
    },
    "unit-converter": {
      title: "대표 변환 기준",
      headers: ["기준", "값"],
  ...
  en: {
    ...
    "salary-net-calculator": { title: "2026 Monthly Deduction Basis", intro: "Insurance and tax are calculated separately using their own rules instead of being combined into one deduction rate.", headers: ["Item", "Calculation basis"], rows: [["National Pension", "Employee share of 4.75%, with the KRW 410,000 to KRW 6,590,000 contribution-income range"], ["Health Insurance", "Employee half of the 7.19% employee health-insurance rate: 3.595%"], ["Long-term Care", "Calculated from the Health Insurance premium using the Long-term Care rate"], ["Employment Insurance", "Employee share of 0.9%"], ["Earned income tax", "2026 monthly withholding table using non-taxable income, dependents, and child count"], ["Local income tax", "10% of earned income tax"]], note: "Industrial accident insurance is generally employer-paid and is not deducted here. Non-taxable pay, bonuses, year-end settlement, and employer rounding rules can make a payslip differ. The rules were checked against the National Pension Service, National Health Insurance Service, Ministry of Employment and Labor, National Tax Service, and Korean Law Information Center." },
