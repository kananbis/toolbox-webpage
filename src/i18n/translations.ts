...
export const i18n = {
  ko: {
    ...
    tools: {
      ...
      "password-generator": { name: "비밀번호 생성기", description: "길이와 문자 옵션을 선택해 랜덤 비밀번호를 만듭니다.", intro: "대문자, 소문자, 숫자, 특수문자 옵션을 조합해 브라우저에서 비밀번호를 생성합니다.", usage: ["길이와 포함할 문자 종류를 선택합니다.", "생성 버튼을 누릅니다.", "강도 표시를 보고 결과를 복사합니다."], examples: ["16자리 특수문자 포함 비밀번호 생성", "헷갈리는 문자를 제외한 임시 비밀번호 만들기"], faq: koFaq("비밀번호 생성기") },
      "random-number-generator": { name: "랜덤 숫자 생성기", description: "최소값, 최대값, 개수를 정해 랜덤 숫자를 생성합니다.", intro: "추첨 번호, 샘플 데이터, 테스트 값이 필요할 때 사용할 수 있습니다.", usage: ["최소값과 최대값을 입력합니다.", "생성 개수를 정합니다.", "생성된 숫자를 확인합니다."], examples: ["1부터 45까지 숫자 6개 생성", "테스트용 임의 ID 숫자 만들기"], faq: koFaq("랜덤 숫자 생성기") },
      "uuid-generator": { name: "UUID 생성기", description: "브라우저에서 UUID v4 값을 생성합니다.", intro: "개발 테스트나 임시 식별자에 사용할 UUID v4를 간단히 만들 수 있습니다.", usage: ["생성 개수를 입력합니다.", "생성 버튼을 누릅니다.", "필요한 UUID를 복사합니다."], examples: ["테스트 데이터 ID 생성", "임시 파일명에 쓸 고유값 만들기"], faq: koFaq("UUID 생성기") },
      ...
      "pyeong-calculator": { name: "평수 계산기", description: "제곱미터와 평을 서로 변환합니다.", intro: "부동산 면적을 볼 때 자주 쓰는 m²와 평 단위를 간단히 바꿀 수 있습니다.", usage: ["변환 방향을 선택합니다.", "면적 값을 입력합니다.", "평 또는 제곱미터 결과를 확인합니다."], examples: ["84m²를 평으로 변환", "25평을 제곱미터로 변환"], faq: koFaq("평수 계산기") },
      ...
      "random-string-generator": { name: "랜덤 문자열 생성기", description: "길이와 문자 종류를 선택해 랜덤 문자열을 생성합니다.", intro: "테스트 토큰, 임시 코드, 샘플 키처럼 무작위 문자열이 필요할 때 사용합니다.", usage: ["문자열 길이와 생성 개수를 입력합니다.", "포함할 문자 종류를 선택합니다.", "생성된 문자열을 복사합니다."], examples: ["32자리 랜덤 토큰 생성", "숫자와 영문자를 섞은 테스트 코드 만들기"], faq: koFaq("랜덤 문자열 생성기") },
      ...
      "image-compressor": { name: "이미지 압축", description: "JPG, PNG, WebP 이미지의 품질 값을 조정해 파일 용량을 줄입니다.", intro: "이미지를 브라우저에서 다시 인코딩해 원본 용량과 압축 후 용량을 비교합니다.", usage: ["압축할 이미지를 선택합니다.", "품질 값을 10~100 사이에서 조정합니다.", "압축 후 용량과 미리보기를 확인합니다.", "압축 이미지를 다운로드합니다."], examples: ["웹 업로드 전 JPG 용량 줄이기", "WebP 이미지를 낮은 품질로 재압축"], faq: koFaq("이미지 압축") },
