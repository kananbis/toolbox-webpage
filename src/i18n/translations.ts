...
export const baseTools = [
  ...
  { slug: "audio-converter", category: "audio", privacy: true },
...
export const i18n = {
  ko: {
    ...
    tools: {
      ...
      "audio-converter": { name: "오디오 변환기", description: "사용자가 직접 보유한 오디오 파일을 브라우저에서 MP3, WAV, OGG로 변환합니다. 선택한 파일은 서버로 업로드되지 않습니다.", seoTitle: "오디오 변환기 - MP3 WAV OGG 파일 변환", intro: "직접 보유한 오디오 파일을 선택해 브라우저 안에서 변환합니다. 외부 URL이나 동영상 플랫폼 다운로드 기능은 제공하지 않습니다.", usage: ["변환할 오디오 파일을 선택합니다.", "출력 형식을 선택합니다.", "필요한 경우 비트레이트나 품질을 선택합니다.", "변환 버튼을 누릅니다.", "변환이 완료되면 결과 파일을 다운로드합니다."], examples: ["WAV 파일을 MP3로 변환해 파일 크기 줄이기", "MP3 파일을 WAV로 변환해 편집용 파일 만들기", "OGG 파일을 MP3로 변환해 호환성 높이기"], faq: [{ question: "선택한 오디오 파일이 서버로 업로드되나요?", answer: "아니요. 선택한 파일은 서버로 업로드되지 않고 브라우저 안에서만 처리됩니다." }, { question: "어떤 파일 형식을 지원하나요?", answer: "현재는 MP3, WAV, OGG 파일만 지원합니다." }, { question: "YouTube 영상을 MP3로 변환할 수 있나요?", answer: "아니요. 이 도구는 외부 URL이나 YouTube 영상을 변환하지 않습니다. 사용자가 직접 보유한 오디오 파일만 변환할 수 있습니다." }, { question: "MP3로 변환하면 음질이 낮아지나요?", answer: "MP3는 손실 압축 형식이므로 비트레이트가 낮을수록 파일 크기는 줄어들지만 음질도 낮아질 수 있습니다." }, { question: "WAV로 변환하면 파일 크기가 커질 수 있나요?", answer: "네. WAV는 일반적으로 무압축 형식이므로 MP3나 OGG보다 파일 크기가 커질 수 있습니다." }, { question: "모바일에서도 사용할 수 있나요?", answer: "사용할 수 있지만, 큰 오디오 파일은 모바일 브라우저에서 변환 시간이 길어질 수 있습니다." }] },
      "audio-cutter": { name: "오디오 자르기", description: "직접 보유한 MP3, WAV, OGG 오디오 파일에서 원하는 구간만 브라우저에서 잘라내고 다운로드합니다. 선택한 파일은 서버로 업로드되지 않습니다.", seoTitle: "오디오 자르기 - MP3 WAV OGG 오디오 구간 자르기", intro: "오디오 파일을 선택하고 시작 시간과 종료 시간을 지정해 필요한 구간만 잘라낼 수 있습니다. 외부 URL은 처리하지 않습니다.", usage: ["자를 오디오 파일을 선택합니다.", "시작 시간과 종료 시간을 입력합니다.", "기본 출력 형식은 원본 형식으로 둡니다.", "자르기 버튼을 누릅니다.", "자른 오디오 파일을 다운로드합니다."], examples: ["녹음 파일에서 필요한 구간만 잘라내기", "효과음 앞뒤의 불필요한 무음 제거", "긴 오디오 파일에서 짧은 샘플 구간 만들기"], faq: [{ question: "선택한 오디오 파일이 서버로 업로드되나요?", answer: "아니요. 선택한 파일은 서버로 업로드되지 않고 브라우저 안에서만 처리됩니다." }, { question: "어떤 오디오 형식을 사용할 수 있나요?", answer: "현재는 MP3, WAV, OGG 파일만 지원합니다." }, { question: "출력 파일은 어떤 형식인가요?", answer: "기본값은 원본 파일 형식입니다. 직접 선택할 수 있는 형식은 WAV, MP3, OGG입니다." }, { question: "모바일에서도 사용할 수 있나요?", answer: "사용할 수 있지만, 큰 오디오 파일은 모바일 브라우저에서 처리 시간이 길어질 수 있습니다." }, { question: "외부 URL의 오디오를 자를 수 있나요?", answer: "아니요. 이 도구는 외부 URL을 처리하지 않고, 사용자가 직접 선택한 오디오 파일만 처리합니다." }] },
      "audio-compressor": { name: "오디오 압축", description: "MP3, WAV, OGG 오디오 파일의 비트레이트와 압축 설정을 조정해 파일 용량을 줄입니다. 선택한 파일은 서버로 업로드되지 않고 브라우저에서 처리됩니다.", seoTitle: "오디오 압축 - MP3 WAV OGG 파일 용량 줄이기", intro: "직접 보유한 MP3, WAV, OGG 오디오 파일을 선택해 브라우저 안에서 용량을 줄입니다. 외부 URL이나 동영상 플랫폼 다운로드 기능은 제공하지 않습니다.", usage: ["압축할 오디오 파일을 선택합니다.", "압축 프리셋 또는 비트레이트를 선택합니다.", "출력 형식을 선택합니다.", "압축 버튼을 누릅니다.", "압축 결과를 확인하고 파일을 다운로드합니다."], examples: ["WAV 파일을 MP3로 압축해 파일 크기 줄이기", "320kbps MP3 파일을 128kbps로 줄이기", "음성 녹음 파일을 64kbps Mono로 압축하기", "OGG 파일의 비트레이트를 낮춰 용량 줄이기"], faq: [{ question: "선택한 오디오 파일이 서버로 업로드되나요?", answer: "아니요. 선택한 파일은 서버로 업로드되지 않고 브라우저 안에서만 처리됩니다." }, { question: "어떤 파일 형식을 지원하나요?", answer: "현재는 MP3, WAV, OGG 파일만 지원합니다." }, { question: "어떤 출력 형식으로 압축할 수 있나요?", answer: "MP3와 OGG 출력을 우선 지원합니다. WAV는 일반적으로 무압축 형식이므로 압축 목적에는 적합하지 않을 수 있습니다." }, { question: "비트레이트를 낮추면 음질이 나빠지나요?", answer: "네. 비트레이트가 낮을수록 파일 크기는 줄어들 수 있지만 음질도 낮아질 수 있습니다." }, { question: "음성 파일은 어떤 설정이 좋나요?", answer: "강의, 회의 녹음, 메모 음성처럼 용량이 중요한 경우 64kbps Mono 설정을 사용할 수 있습니다." }, { question: "음악 파일은 어떤 설정이 좋나요?", answer: "일반적인 음악 파일은 128kbps 또는 192kbps 설정을 권장합니다." }, { question: "압축했는데 파일 크기가 더 커질 수도 있나요?", answer: "네. 원본 파일 형식, 원본 비트레이트, 선택한 출력 형식에 따라 결과 파일이 원본보다 커질 수 있습니다." }, { question: "모바일에서도 사용할 수 있나요?", answer: "사용할 수 있지만, 큰 오디오 파일은 모바일 브라우저에서 처리 시간이 길어질 수 있습니다." }, { question: "외부 URL의 오디오를 압축할 수 있나요?", answer: "아니요. 이 도구는 외부 URL을 처리하지 않고, 사용자가 직접 선택한 오디오 파일만 처리합니다." }] },
      "audio-volume-editor": { name: "오디오 볼륨 조절", description: "MP3, WAV, OGG 오디오 파일의 소리 크기를 키우거나 줄이고, 페이드 인과 페이드 아웃을 브라우저에서 적용합니다. 선택한 파일은 서버로 업로드되지 않습니다.", seoTitle: "오디오 볼륨 조절 - 소리 키우기 줄이기 및 페이드 인/아웃", intro: "직접 보유한 MP3, WAV, OGG 오디오 파일을 선택해 볼륨을 조절하고 페이드 인/아웃을 적용합니다. 외부 URL이나 동영상 플랫폼 다운로드 기능은 제공하지 않습니다.", usage: ["볼륨을 조절할 오디오 파일을 선택합니다.", "볼륨 값을 선택하거나 직접 입력합니다.", "필요한 경우 페이드 인 또는 페이드 아웃을 설정합니다.", "출력 형식을 선택합니다.", "적용 버튼을 누릅니다.", "결과를 미리 듣고 파일을 다운로드합니다."], examples: ["녹음 파일의 소리 크기를 150%로 키우기", "너무 큰 오디오 파일의 볼륨을 70%로 줄이기", "효과음 시작 부분에 1초 페이드 인 적용하기", "음악 끝부분에 3초 페이드 아웃 적용하기", "음성 파일을 작게 만들고 끝부분을 자연스럽게 줄이기"], faq: [{ question: "선택한 오디오 파일이 서버로 업로드되나요?", answer: "아니요. 선택한 파일은 서버로 업로드되지 않고 브라우저 안에서만 처리됩니다." }, { question: "어떤 파일 형식을 지원하나요?", answer: "현재는 MP3, WAV, OGG 파일만 지원합니다." }, { question: "볼륨을 100%보다 크게 올려도 되나요?", answer: "가능합니다. 다만 볼륨을 크게 올리면 일부 구간에서 소리가 깨지거나 왜곡될 수 있습니다." }, { question: "페이드 인과 페이드 아웃을 동시에 적용할 수 있나요?", answer: "네. 시작 부분에는 페이드 인을, 끝 부분에는 페이드 아웃을 동시에 적용할 수 있습니다." }, { question: "출력 형식은 무엇을 지원하나요?", answer: "MP3, WAV, OGG 출력을 지원합니다. MP3와 OGG는 브라우저에서 ffmpeg.wasm을 사용해 인코딩합니다." }, { question: "모바일에서도 사용할 수 있나요?", answer: "사용할 수 있지만, 큰 오디오 파일은 모바일 브라우저에서 처리 시간이 길어질 수 있습니다." }, { question: "외부 URL의 오디오를 편집할 수 있나요?", answer: "아니요. 이 도구는 외부 URL을 처리하지 않고, 사용자가 직접 선택한 오디오 파일만 처리합니다." }] },
  ...
  en: {
    ...
    tools: {
      ...
      "audio-converter": { name: "Audio Converter", description: "Convert your own audio files to MP3, WAV, and OGG directly in your browser. Selected files are not uploaded to a server.", seoTitle: "Audio Converter - Convert MP3, WAV, and OGG Files", intro: "Choose an audio file you own and convert it in your browser. This tool does not support external URLs or video platform downloads.", usage: ["Choose an audio file to convert.", "Select the output format.", "Choose a bitrate or quality setting if needed.", "Click the convert button.", "Download the converted file when conversion is complete."], examples: ["Convert a WAV file to MP3 to reduce file size", "Convert an MP3 file to WAV for editing", "Convert an OGG file to MP3 for better compatibility"], faq: [{ question: "Is my audio file uploaded to a server?", answer: "No. Selected files are not uploaded to a server and are processed only in your browser." }, { question: "What file formats are supported?", answer: "Currently, only MP3, WAV, and OGG files are supported." }, { question: "Can I convert YouTube videos to MP3?", answer: "No. This tool does not convert external URLs or YouTube videos. It only converts audio files that you select from your device." }, { question: "Does converting to MP3 reduce audio quality?", answer: "MP3 is a lossy format, so lower bitrates can reduce file size but may also reduce audio quality." }, { question: "Can WAV output be larger?", answer: "Yes. WAV is usually uncompressed, so it can be much larger than MP3 or OGG." }, { question: "Can I use this on mobile?", answer: "Yes, but large audio files may take longer to convert in a mobile browser." }] },
      "audio-cutter": { name: "Audio Cutter", description: "Trim your own MP3, WAV, and OGG audio files directly in your browser and download the selected section. Selected files are not uploaded to a server.", seoTitle: "Audio Cutter - Trim MP3, WAV, and OGG Audio Files Online", intro: "Choose an audio file, enter the start and end times, and cut only the section you need. This tool does not process external URLs.", usage: ["Choose an audio file to trim.", "Enter the start and end times.", "Keep the default output format as the original format.", "Click the trim button.", "Download the trimmed audio file."], examples: ["Cut only the needed part from a recording", "Remove unnecessary silence from the beginning or end of a sound effect", "Create a short sample from a longer audio file"], faq: [{ question: "Is my audio file uploaded to a server?", answer: "No. Selected files are not uploaded to a server and are processed only in your browser." }, { question: "What audio formats can I use?", answer: "Currently, only MP3, WAV, and OGG files are supported." }, { question: "What output format does it use?", answer: "The default is the original file format. You can manually choose WAV, MP3, or OGG." }, { question: "Can I use this on mobile?", answer: "Yes, but large audio files may take longer to process in a mobile browser." }, { question: "Can I trim audio from an external URL?", answer: "No. This tool does not process external URLs. It only works with audio files selected from your device." }] },
      "audio-compressor": { name: "Audio Compressor", description: "Reduce MP3, WAV, and OGG audio file size by adjusting bitrate and compression settings. Selected files are processed in your browser and are not uploaded to a server.", seoTitle: "Audio Compressor - Reduce MP3, WAV, and OGG File Size", intro: "Choose your own MP3, WAV, or OGG audio file and reduce its size in your browser. This tool does not support external URLs or video platform downloads.", usage: ["Choose an audio file to compress.", "Select a compression preset or bitrate.", "Choose the output format.", "Click the compress button.", "Check the result and download the compressed file."], examples: ["Compress a WAV file to MP3 to reduce file size", "Reduce a 320 kbps MP3 file to 128 kbps", "Compress a voice recording to 64 kbps mono", "Lower the bitrate of an OGG file to reduce size"], faq: [{ question: "Is my audio file uploaded to a server?", answer: "No. Selected files are not uploaded to a server and are processed only in your browser." }, { question: "What file formats are supported?", answer: "Currently, only MP3, WAV, and OGG files are supported." }, { question: "What output formats can I use for compression?", answer: "MP3 and OGG output are prioritized. WAV is usually uncompressed and may not be suitable for reducing file size." }, { question: "Does lowering the bitrate reduce audio quality?", answer: "Yes. Lower bitrates can reduce file size, but audio quality may also decrease." }, { question: "What setting is best for voice recordings?", answer: "For lectures, meetings, and voice memos where file size matters more than quality, 64 kbps mono can be used." }, { question: "What setting is best for music?", answer: "For general music files, 128 kbps or 192 kbps is recommended. Lower bitrates may noticeably reduce quality." }, { question: "Can the compressed file become larger?", answer: "Yes. Depending on the original format, original bitrate, and selected output format, the result may become larger than the original." }, { question: "Can I use this on mobile?", answer: "Yes, but large audio files may take longer to process in a mobile browser." }, { question: "Can I compress audio from an external URL?", answer: "No. This tool does not process external URLs. It only works with audio files selected from your device." }] },
      "audio-volume-editor": { name: "Audio Volume Editor", description: "Adjust the volume of MP3, WAV, and OGG audio files and add fade in or fade out effects directly in your browser. Selected files are not uploaded to a server.", seoTitle: "Audio Volume Editor - Adjust Volume and Add Fade In/Out", intro: "Choose your own MP3, WAV, or OGG audio file, adjust its volume, and add fade in or fade out effects in your browser. This tool does not support external URLs or video platform downloads.", usage: ["Choose an audio file to edit.", "Select or enter a volume value.", "Add fade in or fade out if needed.", "Choose the output format.", "Click the apply button.", "Preview the result and download the file."], examples: ["Increase the volume of a recording to 150%", "Reduce a loud audio file to 70%", "Add a 1-second fade in to the beginning of a sound effect", "Add a 3-second fade out to the end of music", "Lower a voice file and make the ending fade naturally"], faq: [{ question: "Is my audio file uploaded to a server?", answer: "No. Selected files are not uploaded to a server and are processed only in your browser." }, { question: "What file formats are supported?", answer: "Currently, only MP3, WAV, and OGG files are supported." }, { question: "Can I increase the volume above 100%?", answer: "Yes. However, increasing the volume too much may cause clipping or distortion." }, { question: "Can I apply fade in and fade out at the same time?", answer: "Yes. You can apply fade in at the beginning and fade out at the end." }, { question: "What output formats are supported?", answer: "MP3, WAV, and OGG output are supported. MP3 and OGG are encoded in the browser using ffmpeg.wasm." }, { question: "Can I use this on mobile?", answer: "Yes, but large audio files may take longer to process in a mobile browser." }, { question: "Can I edit audio from an external URL?", answer: "No. This tool does not process external URLs. It only works with audio files selected from your device." }] },
...
const toolBasis = {
  ko: {
    ...
    "audio-converter": "오디오 변환은 선택한 오디오 파일을 브라우저에서 디코딩한 뒤, 선택한 출력 형식과 품질 설정에 맞게 다시 인코딩하는 방식으로 처리합니다. MP3와 OGG 같은 손실 압축 형식은 비트레이트가 낮을수록 파일 크기가 줄어들 수 있지만 음질도 낮아질 수 있습니다. WAV는 일반적으로 무압축 형식이므로 파일 크기가 커질 수 있습니다. 선택한 파일은 서버로 업로드되지 않고 현재 브라우저 안에서만 처리됩니다.",
    "audio-cutter": "오디오 자르기는 선택한 오디오 파일을 브라우저에서 디코딩한 뒤, 사용자가 지정한 시작 시간과 종료 시간 사이의 샘플만 추출해 새 오디오 파일로 생성하는 방식으로 처리합니다. 기본 출력은 원본 파일 형식을 우선 사용합니다. WAV는 일반적으로 무압축 형식이므로 원본보다 파일 크기가 커질 수 있고, MP3와 OGG 출력은 브라우저 안에서 ffmpeg.wasm을 사용해 인코딩합니다. 선택한 파일은 서버로 업로드되지 않고 현재 브라우저 안에서만 처리됩니다.",
    "audio-compressor": "오디오 압축은 선택한 오디오 파일을 브라우저에서 디코딩한 뒤, 선택한 출력 형식과 비트레이트 설정에 맞게 다시 인코딩하는 방식으로 처리합니다. 비트레이트가 낮을수록 파일 크기는 줄어들 수 있지만 음질도 낮아질 수 있습니다. Stereo를 Mono로 변환하면 채널 수가 줄어들어 음성 파일의 용량을 더 줄일 수 있습니다. WAV는 일반적으로 무압축 형식이므로 압축 목적에는 MP3 또는 OGG 출력이 더 적합합니다. 감소율은 `(원본 크기 - 압축 후 크기) / 원본 크기 × 100`으로 계산합니다. 선택한 파일은 서버로 업로드되지 않고 현재 브라우저 안에서만 처리됩니다.",
    "audio-volume-editor": "오디오 볼륨 조절은 선택한 오디오 파일을 브라우저에서 디코딩한 뒤, 각 오디오 샘플에 사용자가 선택한 볼륨 배율을 적용하는 방식으로 처리합니다. 100%는 원본 볼륨을 유지하고, 50%는 샘플 값을 0.5배로 줄이며, 200%는 샘플 값을 2배로 키웁니다. 페이드 인은 오디오 시작 부분의 볼륨을 0에서 설정된 볼륨 값까지 점진적으로 증가시키는 방식입니다. 페이드 아웃은 오디오 끝 부분의 볼륨을 설정된 볼륨 값에서 0까지 점진적으로 감소시키는 방식입니다. 볼륨을 크게 올리면 일부 구간에서 클리핑이나 왜곡이 발생할 수 있습니다. 선택한 파일은 서버로 업로드되지 않고 현재 브라우저 안에서만 처리됩니다.",
  ...
  en: {
    ...
    "audio-converter": "Audio conversion works by decoding the selected audio file in the browser and re-encoding it using the selected output format and quality settings. Lossy formats such as MP3 and OGG can reduce file size at lower bitrates, but audio quality may also decrease. WAV is usually uncompressed, so the output file may be larger. Selected files are not uploaded to a server and are processed only in your browser.",
    "audio-cutter": "Audio trimming works by decoding the selected audio file in the browser and extracting only the samples between the selected start and end times. The default output uses the original file format when possible. WAV is usually uncompressed and may be larger than the original file, while MP3 and OGG output are encoded in the browser using ffmpeg.wasm. Selected files are not uploaded to a server and are processed only in your browser.",
    "audio-compressor": "Audio compression works by decoding the selected audio file in the browser and re-encoding it using the selected output format and bitrate settings. Lower bitrates can reduce file size, but audio quality may also decrease. Converting stereo audio to mono can further reduce file size, especially for voice recordings. WAV is usually uncompressed, so MP3 or OGG output is more suitable for compression. The reduction rate is calculated as `(original size - compressed size) / original size × 100`. Selected files are not uploaded to a server and are processed only in your browser.",
    "audio-volume-editor": "Audio volume editing works by decoding the selected audio file in the browser and applying the selected volume multiplier to each audio sample. 100% keeps the original volume, 50% reduces sample values by half, and 200% doubles the sample values. Fade in gradually increases the volume from 0 to the selected volume level at the beginning of the audio. Fade out gradually decreases the volume from the selected volume level to 0 at the end of the audio. Increasing the volume too much may cause clipping or distortion in some parts. Selected files are not uploaded to a server and are processed only in your browser.",
